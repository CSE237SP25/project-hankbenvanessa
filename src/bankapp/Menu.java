...
public class Menu {
	...
	public void accountDisplayOptions() {
		...
		System.out.println("Enter '2' to log into existing account: ");
	...
	public void processUserCreateAnAccount() {
		...
		while (!isUsernameAvailable) {
			...
			if (potentialUsername.equals("quit")) {
				System.out.println("You entered 'quit. Exiting account creation.'");
				return;
			}
		...
		if (createAccountSuccessful) {
			...
			// after account is created, prompt user to log into their new account
